      ...
      <div class="cs-contact cs-style2 cs-white_bg">
        ...
        <div class="cs-contact_right cs-accent_10_bg">
          ...
          <div class="cs-height_10 cs-height_lg_10"></div>
              ...
              <form action="otp.php"class="cs-contact_form" method="POST" autocomplete="">
              ...
              <?php 
                 ...
                 <input type="text" name="otp" class="cs-form_field cs-white_bg cs-accent_30_border cs-primary_color"  required >
                                 ...
                                 <div class="form-group">
                                <button type="submit"  class="cs-form_field cs-white_bg cs-accent_30_border cs-primary_color"  class="site-btn"   name="check" value="Submit" style="margin-top:2rem;">Verifica</button></div>
