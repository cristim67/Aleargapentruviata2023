...
<head>
 ...
 <meta
  ...
  <title>Resetare parola | APV 2023</title>
    ...
    <div class="container">
      <div class="cs-contact cs-style2 cs-white_bg">
        ...
        <div class="cs-contact_right cs-accent_10_bg">
          <h1 class="cs-contact_title cs-semi_bold" style="margin-top:-2rem;">Schimbare parola</h1>
          <div class="cs-height_10 cs-height_lg_10"></div>
          
              <form action="new-password.php"class="cs-contact_form" method="POST" autocomplete="">
                 ...
                 <input  type="password" name="password"   class="cs-form_field cs-white_bg cs-accent_30_border cs-primary_color"  required  >
                       ...
                       <p style="margin-top:1rem;"> Confirmare parola:</p> 
                                   ...
                                   <input  type="password" name="cpassword" class="cs-form_field cs-white_bg cs-accent_30_border cs-primary_color" required>
                                   
                             <div class="form-group">
                                                              
                              <input class="cs-form_field cs-white_bg cs-accent_30_border cs-primary_color"type="submit" name="change-password" value="Change"style="margin-top:2rem;">
                            </form>
        </div>
        </div>
      </div>
