...
<head>
 ...
 <meta
  ...
  <title>Autentificare | APV 2023</title>
    ...
    <div class="container">
      <div class="cs-contact cs-style2 cs-white_bg">
        ...
        <div class="cs-contact_right cs-accent_10_bg">
          <h1 class="cs-contact_title cs-semi_bold" style="margin-top:-2rem;">Autentificare</h1>
          <div class="cs-height_10 cs-height_lg_10"></div>
          
              <form action="login.php"class="cs-contact_form" method="POST" autocomplete="">
                                 <?php
                    if(count($errors) == 1){
                        ?>
                 ...
                 <input type="email" name="email" class="cs-form_field cs-white_bg cs-accent_30_border cs-primary_color"  required value="<?php echo $email ?>">
                              
                       <p style="margin-top:1rem;"> Parola:</p> 
                                <input type="password" name="password" class="cs-form_field cs-white_bg cs-accent_30_border cs-primary_color"  required>
                                    </div>
                                <div class="link forget-pass text-left" style="margin-bottom: 1.5625rem; margin-left: 3rem; margin-top:2rem;" ><a href="forgot-password.php">Ai uitat parola?</a></div>
                                 <div class="form-group">
                                <button type="submit"  class="cs-form_field cs-white_bg cs-accent_30_border cs-primary_color"  class="site-btn"  name="login" value="Login">Logare</button></div>
                                <div class="link login-link text-center"style="margin-bottom:16rem; margin-top:3rem;">Nu ai încă cont? <p></p> <a href="register.php">Înregistrează-te</a></div>
