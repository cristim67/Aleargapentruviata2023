...
<head>
 ...
 <meta
  ...
  <title>ALL FOR ONE | APV 2023</title>
        ...
        <div class="cs-blog_details cs-style1">
          <div class="cs-blog_details_head">
            <div class="cs-blog_details_info">
              ...
              <h1 class="cs-blog_details_title">ALL FOR ONE - TOATE VÂRSTELE</h1>
         <div class="cs-post_date"><h5> ORA DE START: 11:30</h5></div>
           <div class="cs-post_date"> <h5>DISTANȚĂ: 400M</h5></div>
           
           <div class="cs-post_date"> <h5>DONAŢIE MINIMĂ: OPŢIONAL</h5></div>
           
            <p>Cursa All For One este o tură populară, necompetitivă, perfectă pentru cei care vor să facă mișcare în natură pe o distanță accesibilă. Aceasta se adresează tuturor persoanelor, de orice vârstă sau gen, chiar și persoanelor cu dizabilități.</p>
          <h4 style="margin-bottom:2rem;">Tocmai în spiritul caritabil din care s-a și născut Aleargă Pentru Viață, participanții sunt încurajați să ofere drept donație pentru Florin cât consideră.</h4>
