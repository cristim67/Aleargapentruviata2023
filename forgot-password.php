    ...
    <div class="container">
      <div class="cs-contact cs-style2 cs-white_bg">
        ...
        <div class="cs-contact_right cs-accent_10_bg">
          <h1 class="cs-contact_title cs-semi_bold" style="margin-top:-2rem;">Resetare parola</h1>
          <div class="cs-height_10 cs-height_lg_10"></div>
          
              <form action="forgot-password.php"class="cs-contact_form" method="POST" autocomplete="">
            ...
            <?php
                 ...
                 <input type="email" name="email"  class="cs-form_field cs-white_bg cs-accent_30_border cs-primary_color"  required value="<?php echo $email ?>" >
                                 ...
                                 <div class="form-group">
                                     <input class="cs-form_field cs-white_bg cs-accent_30_border cs-primary_color" type="submit" name="check-email" value="Continue" style="margin-top:2rem;">
